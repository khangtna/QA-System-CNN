...
#model_json_full = "CNN_train_3c_relu.json"
model_json_full = "c4_pdbn_gtch.json"
...
X_train, y_train, X_test, y_test, X_val, y_val, embedding_layer = dp.load_data_temp()
...
#checkpoint_filepath = 'CNN_doc_raw_train_2c-{epoch:03d}-{val_loss:.4f}-{val_acc:.4f}.h5'
checkpoint_filepath = 'c4_pdbn_gtch-{epoch:03d}-{val_loss:.4f}-{val_acc:.4f}.h5'
