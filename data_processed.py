...
Data_Full_train_2C = "c4_label3.xlsx"  
url_word2vec_aspect = "c4_label3_w2v.model"
...
def load_data_temp():
    ...
    train_data = pd.read_excel(Data_Full_train_2C, 'c4_pdbn_gtch')
    ...
    # dic = {'TQ': 0, 'CTHDH': 1,'BNA':2,'DP_TT':3,'DC_VDLQ':4 , 'QLKG':5,'KN_TT':6,'KNHDH':7,
    #        'DB_TT':8,'PCBN':9,'PTBN':10,'KTMR':11,'CPKGF':12,'PDBN':13,'TT':14,'TT_TN':15}
    dic = {'GT': 0, 'CH': 1}
    #dic = {'knhdh': 0, 'cthdh': 1}
    #dic = {'none': 0, 'CH': 1}
    ...
    # test_data = train_data[100:110]
    # train_data = train_data.drop(test_data.index)
    # val_data = train_data[89:90]
    ...
    with io.open('vocab.json', 'w', encoding='utf-8') as f:
