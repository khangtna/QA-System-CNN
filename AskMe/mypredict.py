...
# question = input()
# question = "Quản lí không gian file"
def processing_predict(question):
  prediction_label1 ="";
  prediction_label2 ="";
  prediction_label3 ="";
  ...
  if label1_pred == ['c1']:
    ...
    if c1_label2_pred == ['cthdh']:
      ...
      token_c1_cthdh_kn, sam_cthdh_kn = load_data("MyData/c1_label3.xlsx","c1_cthdh_kn",max_length2)
      ...
      prediction_label2 =  c1_label2_pred[0];
      token_c1_knhdh_label3, sam_knhdh_label3 = load_data("MyData/c1_label3.xlsx","c1_knhdh",max_length1)
    ...
    if c3_dptt_pred == ['dp_tt']:
      ...
      if c3_kntt_label3_pred == ['kn']:
        ...
        if c3_kntt_pred == ['kn_tt']:
          ...
          token_c3_dptt_label3, sam_c3_dptt_label3 = load_data("MyData/c3_label3_fix.xlsx","c3_kntt",max_length2)
  ...
  return answers
# print("Câu hỏi của bạn: ",a)
# print('--------------------')
# print("Câu trả lời: \n",docs[sorted[len(sorted) - 1]]);
# print('--------------------')
# print("Câu trả lời liên quan: \n1.",docs[sorted[len(sorted) - 2]]);
# print("2.",docs[sorted[len(sorted) - 3]]);
# print("3. ",docs[sorted[len(sorted) - 4]]);
